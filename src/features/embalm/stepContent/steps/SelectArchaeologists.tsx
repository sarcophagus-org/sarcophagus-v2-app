...
export function SelectArchaeologists() {
  ...
  function handleComplete() {
    dispatch(updateStepStatus(StepMap.SelectArchaeologists.id, StepStatus.Complete));
  }

  function handleStart() {
    dispatch(updateStepStatus(StepMap.SelectArchaeologists.id, StepStatus.Started));
  }
